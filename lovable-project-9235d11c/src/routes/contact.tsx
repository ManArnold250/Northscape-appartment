    ...
    <div>
      ...
      <section className="container-x mt-14 grid gap-8 md:grid-cols-5">
        ...
        <div className="md:col-span-2 grid gap-4">
          {[
            { icon: MapPin, title: "Address", copy: "Musanze, Northern Province, Rwanda" },
            { icon: Phone, title: "Phone", copy: "+250 790 659 689\n+250 788 764 000" },
            { icon: Mail, title: "Email", copy: "stay@northscape.rw" },
